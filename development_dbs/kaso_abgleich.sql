...
CREATE TABLE agi_av_kaso_abgleich_import.kaso_daten (
	...
	CONSTRAINT kaso_daten_pkey PRIMARY KEY (t_id)
);
...
COMMENT ON TABLE agi_av_kaso_abgleich_import.differenzen_staging IS 'Differenzen zwischen den AV-Daten und den Katasterschätzungsdaten'
;
...
COMMENT ON TABLE agi_av_kaso_abgleich_import.uebersicht_des_vergleichs_staging IS 'Anzahl Differenzen zwischen den AV-Daten und den Katasterschätzungsdaten pro Gemeinde'
;
